...
class LaSOTExtensionSubset_LangDataset(BaseDataset):
    """
    ...
    def _construct_sequence(self, sequence_name):
        ...
        return Sequence(sequence_name, frames_list, 'lasot_extension_subset_lang', ground_truth_rect.reshape(-1, 4),
                        text_description=text_dsp, object_class=target_class, target_visible=target_visible)
